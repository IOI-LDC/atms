    ...
    <SheetContent side="right" class="create-sheet">
      ...
      <div class="create-sheet-body">
        ...
        <div class="sheet-form">
          ...
          <template v-else>
            <div class="form-field">
              <Label for="list-fa-code"
                >FA Subclass Code <span class="field-required">*</span></Label
              >
              <Input
                id="list-fa-code"
              ...
              <p v-if="isEdit" class="form-help">
                The subclass code cannot be changed after creation.
              </p>
            ...
            <div class="form-field">
              ...
              />
              <p v-if="validationErrors?.type_code" class="form-error">
                {{ validationErrors.type_code[0] }}
              </p>
            </div>
