...
const router = createRouter({
  ...
  routes: [
    ...
    {
      // Standalone printable document — deliberately outside AppLayout so the
      // sidebar and header never reach the paper.
      path: '/work-orders/:workOrderId/part-request',
      name: 'work-order-part-request',
      component: () => import('@/views/work-orders/PartRequestPrintView.vue'),
    },
