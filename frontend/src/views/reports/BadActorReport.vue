...
<template>
  <ReportPage
    ...
    subtitle="Assets, maintenance categories, classes, sizes, or locations with the most confirmed failures (R-6)."
  >
    <template #filters>
      <div class="report-filters">
        ...
        <div class="report-filter">
          <Label for="ba-category">Maintenance category</Label>
          <Select v-model="categoryId">
            <SelectTrigger id="ba-category"><SelectValue /></SelectTrigger>
            <SelectContent>
            ...
            <tbody>
              <tr v-for="(row, i) in rows" :key="String(row.group_key)">
                ...
                <td class="report-cell-strong">
                  <AssetIdentity v-if="appliedGroupBy === 'asset'" :asset="row.asset" stacked />
