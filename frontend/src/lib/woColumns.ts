...
export const woColumns: ColumnDef<WorkOrder>[] = [
  ...
  // Renders the full identity package; serial, size and category are badges
  // inside this cell, filtered from the toolbar rather than their own columns.
  {
    field: 'asset',
    header: 'Asset',
    sortable: false,
    minWidth: 320,
    searchFields: ['asset.serial_number', 'asset.size', 'asset.maintenance_category.name'],
  },
