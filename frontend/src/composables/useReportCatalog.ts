...
export function useReportCatalog(): {
      ...
      items: [
        {
          ...
          question:
            'Where do failures concentrate — by asset, maintenance category, asset class, size, or location?',
          status: 'available',
        },
        {
          id: 'R-4',
          ...
          question:
            'What is our repair turnaround by asset, maintenance category, asset class, size, or technician?',
          status: 'available',
        },
        {
          id: 'R-5',
        ...
        },
        {
          ...
          question:
            'Which assets, maintenance categories, asset classes, sizes, or locations have the most confirmed failures?',
          status: 'available',
        },
      ],
    },
  ...
  const availableThemes: ReportThemeGroup[] = allThemes
    .map((theme) => ({
      ...theme,
      items: theme.items.filter((item) => item.status === 'available'),
    }))
