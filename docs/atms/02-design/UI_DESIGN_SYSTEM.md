...
## Assembly Status Tokens

| Token | Color Family | Usage |
|---|---|---|
| Installed | Primary (navy) | Component currently installed inside a parent |
| Ready | Success (green) | Spare component available for installation |
| PM OK 🟢 | Success | Child component well within PM interval |
| PM Soon 🟡 | Warning (amber) | Child component approaching PM interval |
| PM Due 🔴 | Destructive (red) | Child component at or past PM interval |
